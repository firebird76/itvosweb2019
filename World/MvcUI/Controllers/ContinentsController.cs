...
namespace MvcUI.Controllers
{
    public class ContinentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Area")] Continent continent)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Area")] Continent continent)
        {
            if (id != continent.Id)
            {
                return NotFound();
